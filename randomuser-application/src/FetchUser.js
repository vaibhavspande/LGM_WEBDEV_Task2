...
const FetchUsers = () => {
  ...
  return (
    <>
      <section className="bg-black-900 py-20 px-10 md:h-screen">
      <h1 className='text-center text-4xl  font-bold '>Random User Generator</h1>
        {users.map((user) => {
          const {
          ...
          return (
            <div
              key={uuid}
              className="bg-blue-200 px-5 py-10 rounded-lg lg:w-9/12 lg:mx-auto 2xl:w-1/2 2xl:px-10"
            >
              ...
              <button
                ...
                className="block mx-auto mt-5 bg-gray-900 text-white py-1 px-4 rounded-lg transition-colors hover:bg-gray-700"
              >
                Next Person
              </button>
            </div>
...
// git remote add origin https://github.com/vaibhavpande2605/LGM_WEBDEV.git
// git branch -M main
